...
<div class="bg-white rounded-lg shadow p-6 max-w-3xl">
    <div class="mb-6">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <p class="text-lg font-semibold {{ $book->available_stock > 0 ? 'text-green-600' : 'text-red-600' }}">
    ...
    <div class="flex gap-3">
        ...
        @else
        <button disabled class="bg-gray-300 text-gray-600 px-6 py-2 rounded-lg cursor-not-allowed">
            Stok Habis
        </button>
        @endif
        <a href="{{ route('user.books.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-6 py-2 rounded-lg">
            Kembali
        </a>
    </div>
</div>
