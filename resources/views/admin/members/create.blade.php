...
@section('header', 'Tambah Anggota Baru (Siswa)')
    ...
    <form method="POST" action="{{ route('admin.members.store') }}">
        ...
        <div class="mb-4">
            ...
            <textarea id="alamat" name="alamat" required rows="3"
                class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg dark:bg-slate-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('alamat') }}</textarea>
        </div>
